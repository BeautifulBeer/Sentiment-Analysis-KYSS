...
load_model_path = "data_roberta_sentiment_model_65_best.pt" # EDIT
load_optimizer_path = "data_roberta_sentiment_optimizer_65_best.pt" # EDIT
output_model_name = 'data65_finetune_active_dropout_roberta_sentiment_model' # EDIT
output_optimizer_name = 'data65_finetune_active_dropout_roberta_sentiment_optimizer' # EDIT
...
submission.to_csv('data65_finetune_active_dropout_submission_30.csv', index=False) # EDIT
