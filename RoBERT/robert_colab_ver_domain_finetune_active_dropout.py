...
load_model_path = "domain_roberta_sentiment_model_75_best.pt" # EDIT
load_optimizer_path = "domain_roberta_sentiment_optimizer_75_best.pt" # EDIT
output_model_name = 'domain75_finetune_active_dropout_roberta_sentiment_model' # EDIT
output_optimizer_name = 'domain75_finetune_active_dropout_roberta_sentiment_optimizer' # EDIT
...
submission.to_csv('domain75_finetune_active_dropout_submission_30.csv', index=False) # EDIT
