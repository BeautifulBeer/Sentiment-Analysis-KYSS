...
load_model_path = "bigtransfer_roberta_sentiment_model_2.pt" # EDIT
load_optimizer_path = "bigtransfer_roberta_sentiment_optimizer_2.pt" # EDIT
output_model_name = 'bigtransfer_roberta_sentiment_model' # EDIT
output_optimizer_name = 'bigtransfer_roberta_sentiment_optimizer' # EDIT
...
# 원래 데이터셋
train = pd.read_csv(data_dir.joinpath('Books_5_preprocessed_trimmed.csv'))  # EDIT
...
submission.to_csv('bigtransfer_submission_5.csv', index=False) # EDIT
