...
output_model_name = 'bigtransfer5_roberta_sentiment_model' # EDIT
output_optimizer_name = 'bigtransfer5_roberta_sentiment_optimizer' # EDIT
...
submission.to_csv('bigtransfer_submission_5_30_final.csv', index=False) # EDIT
