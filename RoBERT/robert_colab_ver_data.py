...
load_model_path = "data_roberta_sentiment_model_50.pt" # EDIT
load_optimizer_path = "data_roberta_sentiment_optimizer_50.pt" # EDIT
output_model_name = 'data_roberta_sentiment_model' # EDIT
output_optimizer_name = 'data_roberta_sentiment_optimizer' # EDIT
...
# 원래 데이터셋
train = pd.read_csv(data_dir.joinpath('merged_10000_train_plus.csv')) # EDIT
...
submission.to_csv('data_submission_80.csv', index=False) # EDIT
