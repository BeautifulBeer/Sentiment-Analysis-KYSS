...
load_model_path = "data65_finetune_roberta_sentiment_model_1_best.pt" # EDIT
load_optimizer_path = "data65_finetune_roberta_sentiment_optimizer_1_best.pt" # EDIT
output_model_name = 'data65_roberta_sentiment_model' # EDIT
output_optimizer_name = 'data65_roberta_sentiment_optimizer' # EDIT
...
submission.to_csv('data_submission_65_1.csv', index=False) # EDIT
