...
load_model_path = "data65_finetune_roberta_sentiment_model_30.pt" # EDIT
load_optimizer_path = "data65_finetune_roberta_sentiment_optimizer_30.pt" # EDIT
output_model_name = 'data65_finetune_roberta_sentiment_model' # EDIT
output_optimizer_name = 'data65_finetune_roberta_sentiment_optimizer' # EDIT
...
submission.to_csv('data65_active_dropout_submission_30.csv', index=False) # EDIT
