...
load_model_path = "domain75_finetune_roberta_sentiment_model_30.pt" # EDIT
load_optimizer_path = "domain75_finetune_roberta_sentiment_optimizer_30.pt" # EDIT
output_model_name = 'domain75_finetune_roberta_sentiment_model' # EDIT
output_optimizer_name = 'domain75_finetune_roberta_sentiment_optimizer' # EDIT
...
# 원래 데이터셋
train = pd.read_csv(data_dir.joinpath('train_final.csv')) # EDIT
...
submission.to_csv('domain_finetune_submission_75_50_final.csv', index=False) # EDIT
